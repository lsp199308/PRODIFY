...
def calculate_checksum():
    ...
    result_var.set(f"Calculated Serial Number: {final_serial_number}")
...
number_edit_label = tk.Label(input_frame, text="Number Edit")
...
dropdown2_values = ["Erista", "Lite", "Mariko", "Oled"]
...
dropdown3_values = ["China", "Europe", "Japan", "Korea", "All (development)", "Malaysia", "Americas"]
...
tk.Label(input_frame, text="Enter 8-Digit Number").grid(row=3, column=0, padx=(0, 0), pady=5, sticky=tk.W)
...
result_button = tk.Button(input_frame, text="Auto Display", command=calculate_checksum, height=1)
